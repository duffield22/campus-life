...
<!-- BODY SECTION -->
      ...
      <div class="container">
          ...
          <div class="dropdown" id="dd">
            ...
            <div class="dropdown-content scroll-menu">
              ...
              <hr class="dropdown-divider">
              <a href="#3">Kappa Alpha Order</a>
              <hr class="dropdown-divider">
              <a href="#4">Kappa Sigma</a>
              <hr class="dropdown-divider">
              <a href="#5">Sigma Alpha Epsilon</a>
              <hr class="dropdown-divider">
              ...
              <hr class="dropdown-divider">
              <a href="#14">Kappa Alpha Psi Fraternity, Inc. /a>
              <hr class="dropdown-divider">
              <a href="#15">Omega Psi Phi Fraternity Inc.</a>
              <hr class="dropdown-divider">
          ...
          <div class="row align-items-center mt-5">
              ...
              <div class="col-lg-6 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Our Mission</h3>
                        <p class="mb-4 size-18">The Office of Fraternity and Sorority Life commits to the holistic development and success of all students, the cultivation of inclusive spaces and communities, and the fostering of meaningful relationships and lifelong learning.</p>
                      <p class="mb-4 size-18">Marshall University has been the host of fraternities and sororities for 97 years. Today, the community has over 500 students holding membership in 17 organizations. The Office of Fraternity and Sorority Life (FSL) focuses on scholarship, unity, service and philanthropy, and leadership. Several of Marshall’s most distinguished graduates are members of fraternities and sororities.</p>
                      <h4 class="title font-weight-medium mb-4 header-colorize">Contact Us</h4>
                        <p class="mb-4 size-18">Phone Number: 304-696-6776</p>
                          <a href="contact.php"<p class="mb-4 size-18">Email: fsl@marshall.edu</p></a>
                  </div>
              </div>
          </div>
      </div>
  ...
  <h2 class="highlight header-colorize text-uppercase mb-5">Interfraternity <br /> Recruitment</h2>
          <div class="row align-items-center mt-5" id=1>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Alpha Sigma Phi</h3>
                        <p class="mb-4 size-18">Founded at Yale University on December 6, 1845, Alpha Sigma Phi was founded upon five virtues: Charity, Honor, Purity, Silence, and Patriotism. Called the “Old Gal,” Alpha Sigma Phi was founded as a sophomore literary society but has grown to be much more. We push for academic and social excellence while fostering a meaningful brotherhood.</p>
                      <p class="mb-4 size-18">Alpha Sigma Phi’s motto is “To Better the Man” which is exactly what we strive to do here at Marshall University. Alpha Sigma Phi was founded at Marshall University in 1929. The brothers of the Beta Delta chapter hold us to the highest standards including, our academics and philanthropic opportunities in the Huntington community.</p>
                      <p class="mb-4 size-18">In the last years, the Beta Delta Chapter averaged a 3.0 GPA at Marshall University. Alongside this statistic, the Beta Delta chapter has served over 1,600 community service hours, benefiting service organizations. These organizations include, but are not limited to, Night to Shine Program, Ronald McDonald House, and Homes for Our Troops.</p>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=2>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Alpha Tau Omega</h3>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=3>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Kappa Alpha Order</h3>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=4>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Kappa Sigma</h3>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=5>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Sigma Alpha Epsilon</h3>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=6>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Sigma Phi Epsilon</h3>
  ...
  <h2 class="highlight header-colorize text-uppercase mb-5 mt-3">Panhellinic Sorority<br />Recruitment</h2>
          <div class="row align-items-center mt-5" id=8>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Alpha Chi Omega</h3>
                        <p class="mb-4 size-18"></p>
                      <p class="mb-4 size-18"></p>
                      <a href="https://www.marshall.edu/fsl/" class="learn-more size-15">Learn more <span class="ml-2 right-icon"><i class="fas fa-arrow-right"></i></span></a>
                      <a class="float-end" href="#dd">Back To Dropdown Selection</a>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=9>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Alpha Xi Delta</h3>
                        <p class="mb-4 size-18"></p>
                      <p class="mb-4 size-18"></p>
                      <a href="https://www.marshall.edu/fsl/" class="learn-more size-15">Learn more <span class="ml-2 right-icon"><i class="fas fa-arrow-right"></i></span></a>
                      <a class="float-end" href="#dd">Back To Dropdown Selection</a>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=10>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Delta Zeta</h3>
                        <p class="mb-4 size-18"></p>
                      <p class="mb-4 size-18"></p>
                      <a href="https://www.marshall.edu/fsl/" class="learn-more size-15">Learn more <span class="ml-2 right-icon"><i class="fas fa-arrow-right"></i></span></a>
                      <a class="float-end" href="#dd">Back To Dropdown Selection</a>
  ...
  <h2 class="highlight header-colorize text-uppercase mb-5 mt-3">National Panhellinic <br /> Council Information</h2>
          <div class="row align-items-center mt-5" id=12>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Alpha Phi Alpha Fraternity Inc.</h3>
                        <p class="mb-4 size-18"></p>
                      <p class="mb-4 size-18"></p>
                      <a href="https://www.marshall.edu/fsl/" class="learn-more size-15">Learn more <span class="ml-2 right-icon"><i class="fas fa-arrow-right"></i></span></a>
                      <a class="float-end" href="#dd">Back To Dropdown Selection</a>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=13>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Alpha Kappa Alpha Sorority Inc.</h3>
                        <p class="mb-4 size-18">The mission of Alpha Kappa Alpha Sorority Incorporated is to cultivate and encourage high scholastic and ethical standards, to promote unity and friendship among college women, to study and help ease problems concerning girls and women to improve their social stature, to maintain a progressive interest in college life, and to be of “Service to All Mankind.”</p>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=14>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Kappa Alpha Psi Fraternity, Inc. </h3>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=15>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Omega Psi Phi Fraternity Inc.</h3>
                        <p class="mb-4 size-18">Omega Psi Phi Fraternity, Inc. is the first international fraternal organization founded on the campus of a historically Black college. The fraternity was founded on November 17, 1911, on the campus of Howard University. The founders were three undergraduates — Edgar Amos Love, Oscar James Cooper, and Frank Coleman. Joining them was their faculty adviser, Ernest Everett Just. From the Greek phrase, “Friendship is essential to the soul,” is derived from the name Omega Psi Phi. That phrase was selected as the motto. Manhood, Scholarship, Perseverance, and Uplift were adopted as Cardinal Principles.</p>
  ...
  <section class="section" id="about">
      <div class="container">
          <div class="row align-items-center" id=16>
              <div class="col-lg-10 offset-lg-1">
                  <div class="text-sub mt-5 mt-lg-0">
                      <h3 class="title font-weight-medium mb-4 header-colorize">Delta Sigma Theta Sorority Inc.</h3>
